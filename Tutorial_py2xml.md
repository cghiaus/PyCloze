...
For a quick view of the quiz, [import][Import_questions] the questions in Moodle from the file `PyCloze00.xml` (see `Tutorial_xml2moodle` for how to make a test in Moodle and import questions in `.xml` format).  
